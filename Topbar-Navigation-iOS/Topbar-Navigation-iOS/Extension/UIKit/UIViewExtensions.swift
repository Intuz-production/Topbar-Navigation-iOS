...
extension UIView {
    ...
    func setLeftGradientBackground(colorTop: UIColor, colorMiddle: UIColor ,colorBottom: UIColor, frame: CGRect) {
        let gradientLayer = CAGradientLayer()
        gradientLayer.colors = [colorTop.cgColor, colorMiddle.cgColor,colorMiddle.cgColor,colorTop.cgColor]
    ...
    func setBarGradientColor() {
        let layer0 = CAGradientLayer()
        layer0.colors = [
          UIColor(red: 0.98, green: 0.635, blue: 0.141, alpha: 1).cgColor,
          UIColor(red: 0.282, green: 0.078, blue: 0.604, alpha: 1).cgColor
        ]

        layer0.locations = [0.49, 1]
...
extension UIView {
    ...
    public func addConstaintsToSuperview(leftOffset: CGFloat, topOffset: CGFloat, rightOffset: CGFloat, bottomOffset: CGFloat) {
